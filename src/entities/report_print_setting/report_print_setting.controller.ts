...
export class LaboratoriesController {
  ...
  async getReportMargins(
    ...
    try {
      ...
      const reportPrintSetting =
        await this.reportPrintService.getReportPrintSettings(
  ...
  async changeHeader(
    ...
    try {
      ...
      const reportPrintSetting = await this.reportPrintService.updateHeaderType(
        laboratory?.laboratory_id,
        body,
      );
      response.status(200).send(reportPrintSetting);
      ...
      response
        .status(400)
        .send({ error: err, message: 'header type not changed' });
    }
  }
  ...
  async changeFooter(
    ...
    try {
      ...
      const reportPrintSetting = await this.reportPrintService.updateFooterType(
        laboratory?.laboratory_id,
        body,
      );
      response.status(200).send(reportPrintSetting);
      ...
      response
        .status(400)
        .send({ error: err, message: 'footer type not changed' });
    }
  }
  ...
  async saveSettings(
    ...
    try {
      ...
      const reportPrintSetting =
        await this.reportPrintService.saveReportSettings(
          laboratory?.laboratory_id,
          body,
        );
      response.status(200).send(reportPrintSetting);
  ...
  async saveHeaderText(
    ...
    try {
      ...
      const reportPrintSetting = await this.reportPrintService.saveHeaderText(
        laboratory?.laboratory_id,
        body,
      );
      response.status(200).send(reportPrintSetting);
  ...
  async saveFooterText(
    ...
    try {
      ...
      const reportPrintSetting = await this.reportPrintService.saveFooterText(
        laboratory?.laboratory_id,
        body,
      );
      response.status(200).send(reportPrintSetting);
  ...
  async saveHeaderImage(
    ...
    try {
      if (file) {
        ...
        const header_image_name = await this.directoryManagerService.uploadFile(
          obj,
        );
        const reportPrintSetting =
          await this.reportPrintService.saveHeaderImage(
            laboratory?.laboratory_id,
            header_image_name,
          );
        response.status(200).send(reportPrintSetting);
  ...
  async saveFooterImage(
    ...
    try {
      if (file) {
        ...
        const footer_image_name = await this.directoryManagerService.uploadFile(
          obj,
        );
        const reportPrintSetting =
          await this.reportPrintService.saveFooterImage(
            laboratory?.laboratory_id,
            footer_image_name,
          );
        response.status(200).send(reportPrintSetting);
